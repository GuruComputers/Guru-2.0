...
function make_day_boxes() {
        ...
        foreach ($this->days as $row) {
            ...
            if(isset($row['daynumber']) && $row['daynumber'] != 0) { // Padded days at the start of the month will have a 0 at the beginning
                ...
                echo "<td width='21' valign='top' class='days'><img src='img/book/block_null.gif' title='This day is unavailable' alt=''></td>";
            }
...
function day_switch($tag, $daynumber) {
        ...
        case (2): // Sunday
            $txt = "<img src='img/book/block_sunday.gif' title='This day is not available' border='0' alt=''>\r\n";
            break;

        case (3): // Fully booked day
            $txt= "<img src='img/book/block_fully_booked.gif' title='This day is fully booked' border='0' alt=''>\r\n";
            break;

        case (4): // Past day
            $txt = "<img src='img/book/block_past.gif' title='This day is not available' border='0' alt=''></a>\r\n";
            break;

        case (5): // Block booked out day
            $txt= "<img src='img/book/block_fully_booked.gif' title='This day is not available' border='0' alt=''>\r\n";
            break;
